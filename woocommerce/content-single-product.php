                ...
                <div class="row">
                    ...
                    <div class="col">
                        <div class="mtt-fitness-product mtt-category">
                            <a href="#"><img src="<?php echo get_template_directory_uri(); ?>/img/accessories-icon2.png"
                                    alt=""></a>
                            <h6>STRONG</h6>
                        </div>
                    </div>
                    <div class="col">
                        <div class="mtt-fitness-product mtt-category">
                            <a href="#"><img src="<?php echo get_template_directory_uri(); ?>/img/icon3.png" alt=""></a>
                            <h6>LIGHWEIGHT</h6>
                        </div>
                    </div>
                    <div class="col">
                        <div class="mtt-fitness-product mtt-category">
                            <a href="#"><img src="<?php echo get_template_directory_uri(); ?>/img/accessories-icon4.png"
                                    alt=""></a>
                            <h6>ECO-FRIENDLY</h6>
                        </div>
                    </div>
