    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4 offset-md-4">
                <div class="mtt-login">
                    <h5 class="text-center py-2 mb-4">
                        <?php esc_html_e("Sign into your existing finessCity account", "city-shop"); ?></h5>
                    <?php do_action('woocommerce_before_customer_login_form'); ?>
                    <form class="woocommerce-form woocommerce-form-login login mb-5" method="post">
                        <?php do_action('woocommerce_login_form_start'); ?>
                        <div class="form-group">
                            <label for="username" class="font-weight-bold"><?php esc_html_e('Email', 'woocommerce'); ?>
                                <span class="required">*</span></label>
                            <input type="text" class="woocommerce-Input woocommerce-Input--text input-text form-control"
                                name="username" id="username" placeholder="JOHN.SMIT@EXAMPLE.COM"
                        ...
                        <div class="form-group">
                            <label for="password"
                                class="font-weight-bold"><?php esc_html_e('Password', 'woocommerce'); ?> <span
                        ...
                        <div class="form-group text-right">
                            <a href="<?php echo esc_url(wp_lostpassword_url()); ?>"
                                class="font-weight-bold"><?php esc_html_e('Forgot Password?', 'woocommerce'); ?></a>
                        </div>
                        <?php wp_nonce_field('woocommerce-login', 'woocommerce-login-nonce'); ?>
                        <button type="submit"
                            class="woocommerce-button button woocommerce-form-login__submit btn mtt-btn rounded-0 btn-block"
                            name="login"
                            value="<?php esc_attr_e('SIGN IN', 'woocommerce'); ?>"><?php esc_html_e('SIGN IN', 'woocommerce'); ?></button>
                        <div class="form-group text-center mt-3">
                            <!--  -->
                            <h5 class="text-center py-3">New to finessCity? <a href="<?php echo home_url(); ?>/register"
                                    class="font-weight-bold">Create an account</a></h5>
                        </div>
...
<section class="section mtt-login-form-section">
    <div class="container">
        <div class="row">
            <div class="col-md-4 offset-md-4">
                <div class="mtt-login">
                    <p class="text-center py-2"><?php esc_html_e("Register your finessCity account", "city-shop"); ?>
                    </p>
                    <form method="post" class="woocommerce-form woocommerce-form-register register"
                        <?php do_action('woocommerce_register_form_tag'); ?>>
                        <div class="form-group">
                            <label for="reg_username"
                                class="font-weight-bold"><?php esc_html_e('Username', 'woocommerce'); ?> <span
                                    class="required">*</span></label>
                            <input type="text" class="woocommerce-Input woocommerce-Input--text input-text form-control"
                                name="username" id="reg_username" placeholder="USER NAME" autocomplete="username"
                                value="<?php echo (!empty($_POST['username'])) ? esc_attr(wp_unslash($_POST['username'])) : ''; ?>" />
                            <?php // @codingStandardsIgnoreLine 
									?>
                        </div>
                        <div class="form-group">
                            <label for="reg_email" class="font-weight-bold"><?php esc_html_e('Email', 'woocommerce'); ?>
                                <span class="required">*</span></label>
                            <input type="email"
                                class="woocommerce-Input woocommerce-Input--text input-text form-control" name="email"
                                id="reg_email" placeholder="JOHN.SMIT@EXAMPLE.COM" autocomplete="email"
                        ...
                        <button type="submit"
                            class="woocommerce-Button woocommerce-button button woocommerce-form-register__submit btn mtt-btn rounded-0 btn-block"
                            name="register"
                            value="<?php esc_attr_e('REGISTER', 'woocommerce'); ?>"><?php esc_html_e('REGISTER', 'woocommerce'); ?></button>
                        <p class="text-center py-3 m-0">Already have finessCity Account? <a
                                href="<?php echo home_url(); ?>/login" class="font-weight-bold">Login</a></p>
...
<ul>
    <li>
        <h6>Follow us and Enter into $100 Monthly Prize Draw.</h6>
    </li>
...
<ul>
    <li class="text-align:center;">
        <h6>We Stand Behind all Our Products that's why we provide a Lifetime Warranty on all your Purchases</h6>
    </li>
    <li><a href="#"><i id="popupNoticeTimes" class="fa fa-times"></i></a></li>
</ul>
<?php
            ...
            <div class="col-md-12">
                <div class="mtt-bestseller-section-btn">
                    <a class="btn rounded-0 mtt-btn px-5"
                        href="<?php echo get_permalink(wc_get_page_id('shop')); ?>">VIEW ALL PRODUCTS</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="mtt-bestseller-section-btn">
                    <a class="btn rounded-0 mtt-btn px-5"
                        href="<?php echo get_permalink(wc_get_page_id('shop')); ?>">DISCOVER MORE</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-3 mtt-indoor-product-col1 pr-0 mb-4 mb-md-0">
                <div class="mtt-product mtt-indoor-product">
                    ...
                    <div class="mtt-indoor-product-info text-center">
                        ...
                        <a class="btn rounded-0 mtt-btn mx-4 mx-md-0 px-4 py-2"
                            href="<?php echo home_url(); ?>/indoor">SHOP NOW</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-3 mtt-outdoor-product-col2 pl-0">
                <div class="mtt-outdoor-product">
                    ...
                    <div class="mtt-outdoor-product-info text-center">
                        ...
                        <h6 class="font-weight-bold">TITANIUM PRODUCTS</h6>
                        <a class="btn rounded-0 mtt-btn mx-4 mx-md-0 px-4 py-2"
                            href="<?php echo home_url(); ?>/outdoor">SHOP NOW</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="row" id="mtt-categories">
                        <div class="col">
                            <div class="mtt-category">
                                <img class="mx-auto" src="<?php echo get_template_directory_uri(); ?>/img/icon1.png"
                                    alt="">
                                <p class="small text-dark mt-2 mb-0">HEALTHY</p>
                            </div>
                        </div>
                        <div class="col">
                            <div class="mtt-fitness-product mtt-category">
                                <img class="mx-auto" src="<?php echo get_template_directory_uri(); ?>/img/icon2.png"
                                    alt="">
                                <p class="small text-dark mt-2 mb-0">STRONG</p>
                            </div>
                        </div>
                        <div class="col">
                            <div class="mtt-fitness-product mtt-category">
                                <img class="mx-auto" src="<?php echo get_template_directory_uri(); ?>/img/icon3.png"
                                    alt="">
                                <p class="small text-dark mt-2 mb-0">LIGHWEIGHT</p>
                            </div>
                        </div>
                        <div class="col">
                            <div class="mtt-fitness-product mtt-category">
                                <img class="mx-auto" src="<?php echo get_template_directory_uri(); ?>/img/icon4.png"
                                    alt="">
                                <p class="small text-dark mt-2 mb-0">ECO-FRIENDLY</p>
                            </div>
                        </div>
                        <div class="col">
                            <div class="mtt-fitness-product mtt-category">
                                <img class="mx-auto" src="<?php echo get_template_directory_uri(); ?>/img/icon5.png"
                                    alt="">
                                <p class="small text-dark mt-2 mb-0">CORROSION RESISTANT</p>
                            </div>
                        </div>
                        <div class="col">
                            <div class="mtt-fitness-product mtt-category">
                                <img class="mx-auto" src="<?php echo get_template_directory_uri(); ?>/img/icon6.png"
                                    alt="">
                                <p class="small text-dark mt-2 mb-0">BACTERIA INHIBITATION</p>
                            </div>
                        </div>
                        <div class="col">
                            <div class="mtt-fitness-product mtt-category">
                                <img class="mx-auto" src="<?php echo get_template_directory_uri(); ?>/img/icon7.png"
                                    alt="">
                                <p class="small text-dark mt-2 mb-0">HIGH TEMPERATURE RESISTANT</p>
                            </div>
                        </div>
                        <div class="col">
                            <div class="mtt-fitness-product mtt-category">
                                <img class="mx-auto" src="<?php echo get_template_directory_uri(); ?>/img/icon8.png"
                                    alt="">
                                <p class="small text-dark mt-2 mb-0">LOW TEMPERATURE RESISTANT</p>
                            </div>
                        </div>
                        <div class="col">
                            <div class="mtt-fitness-product mtt-category">
                                <img class="mx-auto" src="<?php echo get_template_directory_uri(); ?>/img/icon9.png"
                                    alt="">
                                <p class="small text-dark mt-2 mb-0">GOOD HEATING</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="mtt-fitness-p-section-btn">
                    <a class="btn rounded-0 mtt-btn px-5 mt-4" href="<?php echo home_url(); ?>/why-titanium/">WHY YOU
                        SHOULD BUY TITENIUM PRODUCTS?</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row mtt-finess-story-row px-0 px-md-4">
            ...
            <div class="col-md-6 col-sm-12">
                <div class="mtt-finess-story text-center mt-5 mt-md-0">
                    ...
                    <br>
                    <a class="btn rounded-0 mtt-btn text-uppercase px-5"
                        href="<?php echo $atts['link'] ?>"><?php echo $atts['link_text']; ?></a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-12">
                <div class="mtt-instagram-title text-center">
                    ...
                    <h4>SHOP OUR INSTAGRAM <span class="mtt-instagram-title-span">
                            <a href="<?php echo esc_url($instragram_url); ?>" target="_blank">@FITNESSCITY</a></span>
                    </h4>
                </div>
            </div>
        </div>
                    ...
                    <div class="row">
                        <div class="col-md-3 p-0">
                            <a href="https://instagram.com/" target="_blank"><img
                                    src="<?php echo get_template_directory_uri(); ?>/img/11.jpg" alt=""></a>
                        </div>
                        <div class="col-md-3 p-0">
                            <a href="https://instagram.com/" target="_blank"><img
                                    src="<?php echo get_template_directory_uri(); ?>/img/12.jpg" alt=""></a>
                        </div>
                        <div class="col-md-3 p-0">
                            <a href="https://instagram.com/" target="_blank"><img
                                    src="<?php echo get_template_directory_uri(); ?>/img/13.jpg" alt=""></a>
                        </div>
                        <div class="col-md-3 p-0">
                            <a href="https://instagram.com/" target="_blank"><img
                                    src="<?php echo get_template_directory_uri(); ?>/img/14.jpg" alt=""></a>
                        </div>
                        <div class="col-md-3 p-0">
                            <a href="https://instagram.com/" target="_blank"><img
                                    src="<?php echo get_template_directory_uri(); ?>/img/13.jpg" alt=""></a>
                        ...
                        <div class="col-md-3 p-0">
                            <a href="https://instagram.com/" target="_blank"><img
                                    src="<?php echo get_template_directory_uri(); ?>/img/16.jpg" alt=""></a>
                        </div>
                        <div class="col-md-3 p-0">
                            <a href="https://instagram.com/" target="_blank"><img
                                    src="<?php echo get_template_directory_uri(); ?>/img/12.jpg" alt=""></a>
                        ...
                        <div class="col-md-3 p-0">
                            <a href="https://instagram.com/" target="_blank"><img
                                    src="<?php echo get_template_directory_uri(); ?>/img/15.jpg" alt=""></a>
                        </div>
                    </div>
                </div>
            </div>
...
function mtt_row_shortcode($atts = array(), $content = '')
{
	...
	// do shortcode actions here
	ob_start(); ?>
<div class="row <?php echo $atts['class'] ?>" <?php if (!empty($atts['id'])) : ?> id="<?php echo $atts['id']; ?>"
...
function mtt_div_shortcode($atts = array(), $content = '')
{
	...
	ob_start();
	?>
<div class="<?php echo $atts['class'] ?>" <?php if (!empty($atts['id'])) : ?> id="<?php echo $atts['id']; ?>"
    <?php endif ?>><?php echo do_shortcode($content); ?></div>
<?php
	return ob_get_clean();
}
    ...
    <div class="row">
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
            <div class="mtt-category">
                <div class="row">
                    <div class="col p-0">
                        <img src="<?php echo wp_get_attachment_url($items[$i]); ?>"
                            alt="<?php echo get_post($items[$i])->post_title; ?>">
                    </div>
                    <div class="col p-0">
                        <?php
