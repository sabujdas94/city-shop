            ...
            <div class="col-md-12">
                <div class="mtt-bestseller-section-btn">
                    <a class="btn rounded-0 mtt-btn px-5"
                        href="<?php echo get_permalink(woocommerce_get_page_id('shop')); ?>">DISCOVER MORE</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-4 offset-md-4">
                <div class="mtt-login">
                    <p class="text-center py-2">
                        <?php esc_html_e("Sign into your existing finessCity account", "city-shop"); ?></p>
                    ...
                    <form class="woocommerce-form woocommerce-form-login login" method="post">
                        ...
                        <div class="form-group text-center">
                            <input class="woocommerce-form__input woocommerce-form__input-checkbox mt-3"
                                name="rememberme" type="checkbox" id="rememberme" value="forever" />
                            <span><?php esc_html_e('Remember me', 'woocommerce'); ?></span>
                            <p class="text-center py-3">New to finessCity? <a href="<?php echo home_url(); ?>/register"
                                    class="font-weight-bold">Create an account</a></p>
                        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="mtt-fitness-p-section-btn">
                    <a class="btn rounded-0 mtt-btn px-5" href="<?php echo home_url(); ?>/why-titanium/">WHY YOU SHOULD
                        BUY TITENIUM PRODUCTS?</a>
                </div>
            </div>
        </div>
    </div>
